...
'
Namespace wsDocMngServicesCloud
    ...
    Partial Public Class wsDocMngServices
        ...
        Private GetiQuote_PendingQuotationsOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.SemiApp_bl.My.MySettings.Default.SemiApp_bl_wsDocMngServicesCloud_wsDocMngServices
        ...
        '''<remarks/>
        Public Event GetiQuote_PendingQuotationsCompleted As GetiQuote_PendingQuotationsCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapHeaderAttribute("ValidationSoapHeaderValue"),  _
         System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://Iscar.CloudServices/GetiQuote_PendingQuotations", RequestNamespace:="http://Iscar.CloudServices/", ResponseNamespace:="http://Iscar.CloudServices/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GetiQuote_PendingQuotations(ByVal Enviroment As String, ByVal RequestApp As String, ByVal branchCode As String) As Boolean
            Dim results() As Object = Me.Invoke("GetiQuote_PendingQuotations", New Object() {Enviroment, RequestApp, branchCode})
            Return CType(results(0),Boolean)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GetiQuote_PendingQuotationsAsync(ByVal Enviroment As String, ByVal RequestApp As String, ByVal branchCode As String)
            Me.GetiQuote_PendingQuotationsAsync(Enviroment, RequestApp, branchCode, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetiQuote_PendingQuotationsAsync(ByVal Enviroment As String, ByVal RequestApp As String, ByVal branchCode As String, ByVal userState As Object)
            If (Me.GetiQuote_PendingQuotationsOperationCompleted Is Nothing) Then
                Me.GetiQuote_PendingQuotationsOperationCompleted = AddressOf Me.OnGetiQuote_PendingQuotationsOperationCompleted
            End If
            Me.InvokeAsync("GetiQuote_PendingQuotations", New Object() {Enviroment, RequestApp, branchCode}, Me.GetiQuote_PendingQuotationsOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetiQuote_PendingQuotationsOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetiQuote_PendingQuotationsCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetiQuote_PendingQuotationsCompleted(Me, New GetiQuote_PendingQuotationsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3761.0")>  _
    Public Delegate Sub GetiQuote_PendingQuotationsCompletedEventHandler(ByVal sender As Object, ByVal e As GetiQuote_PendingQuotationsCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.3761.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class GetiQuote_PendingQuotationsCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
